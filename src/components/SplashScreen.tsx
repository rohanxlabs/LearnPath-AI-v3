...
export const SplashScreen: React.FC = () => {
  return (
    <div role="status" aria-label="Loading LearnPath AI" className="fixed inset-0 bg-white dark:bg-[#0A0A0A] flex flex-col items-center justify-center z-50">
      <motion.div
      ...
      >
        ...
        <p aria-live="polite" className="text-xs text-zinc-500 dark:text-zinc-400 mt-2">Loading your learning space...</p>
      </motion.div>
    </div>
  );
};
